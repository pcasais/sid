...
public class RangeTypeField extends CustomField<RangeType> {
    ...
    public RangeTypeField() {
        ...
        local.addValueChangeListener(event -> rangeType.setLocal((Boolean) event.getProperty().getValue()));
        ...
        localNetwork.addValueChangeListener(event -> rangeType.setLocalNetwork((Boolean) event.getProperty().getValue()));
        ...
        network.addValueChangeListener(event -> rangeType.setNetwork((Boolean) event.getProperty().getValue()));
        ...
        userInit.addValueChangeListener(event -> rangeType.setUserInit((Boolean) event.getProperty().getValue()));
